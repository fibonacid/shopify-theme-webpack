...
/* harmony import */ var _templates_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./templates/index */ "./src/scripts/templates/index.js");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            (0,_shared__WEBPACK_IMPORTED_MODULE_0__.shared)();
            templateName = document.body.dataset.templateName; // Run logic required by specific templates

            if (templateName === "index") {
              (0,_templates_index__WEBPACK_IMPORTED_MODULE_1__.init)();
            }
...
/* harmony export */ });
/**
 * Runs logic that is required by every page.
 */
...
function init() {
  console.log("homepage"); // Find all sections in the page
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      if (sectionName === "my-section") {// do something
      }
    }
  } catch (err) {
    _iterator.e(err);
